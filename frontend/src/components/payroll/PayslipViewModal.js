...
import { FileText, User, Building, Calendar, DollarSign, ListChecks } from 'lucide-react'; // Icons
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={`Payslip for ${payslip.staff?.contactPersonName || 'N/A'}`} maxWidthClass="max-w-2xl">
            ...
            <div className="p-4 border-t mt-6 flex justify-end">
                ...
                {/* <button className="ml-3 px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Download PDF</button> */}
            </div>
        </Modal>
    );
};
